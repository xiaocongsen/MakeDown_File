...
*布尔类型定义
*/
#define SKF_TRUE			0x00000001	//布尔值为真
#define SKF_FALSE			0x00000000	//布尔值为假
...
typedef ULONG (DEVAPI *PFN_SKF_VerifyPIN)(HAPPLICATION hApplication, ULONG ulPINType, LPSTR szPIN, ULONG *pulRetryCount);
typedef ULONG (DEVAPI *PFN_SKF_GetPINInfo)(HAPPLICATION hApplication, ULONG  ulPINType, ULONG *pulMaxRetryCount, ULONG *pulRemainRetryCount, BOOL *pbDefaultPin);
typedef ULONG (DEVAPI *PFN_SKF_UnblockPIN)(HAPPLICATION hApplication, LPSTR szAdminPIN, LPSTR szNewUserPIN, ULONG *pulRetryCount);
typedef ULONG (DEVAPI *PFN_SKF_ClearSecureState)(HAPPLICATION hApplication);
typedef ULONG (DEVAPI *PFN_SKF_CreateApplication)(DEVHANDLE hDev, LPSTR szAppName, LPSTR szAdminPin, DWORD dwAdminPinRetryCount, LPSTR szUserPin, DWORD dwUserPinRetryCount, DWORD dwCreateFileRights, HAPPLICATION *phApplication);
typedef ULONG (DEVAPI *PFN_SKF_EnumApplication)(DEVHANDLE hDev, LPSTR szAppName, ULONG *pulSize);
typedef ULONG (DEVAPI *PFN_SKF_DeleteApplication)(DEVHANDLE hDev, LPSTR szAppName);
typedef ULONG (DEVAPI *PFN_SKF_OpenApplication)(DEVHANDLE hDev, LPSTR szAppName, HAPPLICATION *phApplication);
typedef ULONG (DEVAPI *PFN_SKF_CloseApplication)(HAPPLICATION hApplication);
typedef ULONG (DEVAPI *PFN_SKF_CreateFile)(HAPPLICATION hApplication, LPSTR szFileName, ULONG ulFileSize, ULONG ulReadRights, ULONG ulWriteRights);
typedef ULONG (DEVAPI *PFN_SKF_DeleteFile)(HAPPLICATION hApplication, LPSTR szFileName);
typedef ULONG (DEVAPI *PFN_SKF_EnumFiles)(HAPPLICATION hApplication, LPSTR szFileList, ULONG *pulSize);
typedef ULONG (DEVAPI *PFN_SKF_GetFileInfo)(HAPPLICATION hApplication, LPSTR szFileName, FILEATTRIBUTE *pFileInfo);
typedef ULONG (DEVAPI *PFN_SKF_ReadFile)(HAPPLICATION hApplication, LPSTR szFileName, ULONG ulOffset, ULONG ulSize, BYTE * pbOutData, ULONG *pulOutLen);
typedef ULONG (DEVAPI *PFN_SKF_WriteFile)(HAPPLICATION hApplication, LPSTR szFileName, ULONG ulOffset, ULONG ulSize, BYTE * pbInData, ULONG *pulInLen);
typedef ULONG (DEVAPI *PFN_SKF_GenRandom)(DEVHANDLE hDev, BYTE * pbData, ULONG ulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_GenExtRSAKey)(DEVHANDLE hDev, ULONG ulBitsLen, RSAPRIVATEKEYBLOB *pBlob);
typedef ULONG (DEVAPI *PFN_SKF_GenRSAKeyPair)(HCONTAINER hContainer, ULONG ulBitsLen, RSAPUBLICKEYBLOB *pBlob);
typedef ULONG (DEVAPI *PFN_SKF_ImportRSAKeyPair)(HCONTAINER hContainer, ULONG ulSymAlgId, BYTE *pbWrappedKey, ULONG ulWrappedKeyLen, BYTE *pbEncryptedData, ULONG ulEncryptedDataLen);
typedef ULONG (DEVAPI *PFN_SKF_RSASignData)(HCONTAINER hContainer, BYTE *pbData, ULONG ulDataLen, BYTE *pbSignature, ULONG *pulSignLen);
typedef ULONG (DEVAPI *PFN_SKF_RSAVerify)(DEVHANDLE hDev , RSAPUBLICKEYBLOB* pRSAPubKeyBlob, BYTE *pbData, ULONG  ulDataLen, BYTE *pbSignature, ULONG ulSignLen);
typedef ULONG (DEVAPI *PFN_SKF_RSAExportSessionKey)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbSessionKey, ULONG ulSessionKeyLen, BYTE * pbExportData, ULONG *pulExportDataLen);
typedef ULONG (DEVAPI *PFN_SKF_ExtRSAPubKeyOperation)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbPubExp, ULONG ulPubExpLen, BYTE * pbModulus, ULONG ulModulusLen, BYTE * pbData, ULONG ulDataLen, BYTE * pbResult, ULONG *pulResultLen);
typedef ULONG (DEVAPI *PFN_SKF_ExtRSAPriKeyOperation)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbPubExp, ULONG ulPubExpLen, BYTE * pbModulus, ULONG ulModulusLen, BYTE * pbPrivateExponent, ULONG ulPrivateExponentLen, BYTE * pbData, ULONG ulDataLen, BYTE * pbResult, ULONG *pulResultLen);
typedef ULONG (DEVAPI *PFN_SKF_GenECCKeyPair)(HCONTAINER hContainer, ULONG ulAlgId, ECCPUBLICKEYBLOB *pBlob);
typedef ULONG (DEVAPI *PFN_SKF_ImportECCKeyPair)(HCONTAINER hContainer, PENVELOPEDKEYBLOB pEnvelopedKeyBlob);
typedef ULONG (DEVAPI *PFN_SKF_ECCVerify)(DEVHANDLE hDev , ECCPUBLICKEYBLOB* pECCPubKeyBlob, BYTE *pbData, ULONG  ulDataLen, PECCSIGNATUREBLOB pSignature);
typedef ULONG (DEVAPI *PFN_SKF_ECCExportSessionKey)(HCONTAINER hContainer, ULONG ulAlgId, ECCPUBLICKEYBLOB *pPubKey, PECCCIPHERBLOB pData, HANDLE *phSessionKey);
typedef ULONG (DEVAPI *PFN_SKF_ExtECCEncrypt)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbPubKey, ULONG ulPubKeyLen, BYTE * pbData, ULONG ulDataLen, BYTE * pbCipherText, ULONG *pulCipherTextLen);
typedef ULONG (DEVAPI *PFN_SKF_ExtECCDecrypt)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbPrivKey, BYTE * pbPubKey, ULONG ulPubKeyLen, BYTE * pbCipherText, ULONG ulCipherTextLen, BYTE * pbData, ULONG *pulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_ExtECCSign)(DEVHANDLE hDev, ULONG ulAlgID, BYTE * pbPrivKey, BYTE * pbData, ULONG ulDataLen, BYTE * pbSignature, ULONG *pulSigLen);
typedef ULONG (DEVAPI *PFN_SKF_ExtECCVerify)(DEVHANDLE hDev, ECCPUBLICKEYBLOB* pECCPubKeyBlob, BYTE* pbData, ULONG ulDataLen, PECCSIGNATUREBLOB pSignature);
typedef ULONG (DEVAPI *PFN_SKF_ExportPublicKey)(HCONTAINER hContainer, BOOL bSignFlag, BYTE* pbBlob, ULONG* pulBlobLen);
typedef ULONG (DEVAPI *PFN_SKF_ImportSessionKey)(HCONTAINER hContainer, ULONG ulAlgId, BYTE *pbWrapedData, ULONG ulWrapedLen, HANDLE *phKey);
typedef ULONG (DEVAPI *PFN_SKF_SetSymmKey)(DEVHANDLE hDev, BYTE* pbKey, ULONG ulAlgID, HANDLE* phKey);
typedef ULONG (DEVAPI *PFN_SKF_EncryptInit)(HANDLE hKey, BLOCKCIPHERPARAM EncryptParam);
typedef ULONG (DEVAPI *PFN_SKF_Encrypt)(HANDLE hKey, BYTE * pbData, ULONG ulDataLen, BYTE *pbEncryptedData, ULONG *pulEncryptedLen);
typedef ULONG (DEVAPI *PFN_SKF_EncryptUpdate)(HANDLE hKey, BYTE * pbData, ULONG ulDataLen, BYTE *pbEncryptedData, ULONG *pulEncryptedLen);
typedef ULONG (DEVAPI *PFN_SKF_EncryptFinal)(HANDLE hKey, BYTE *pbEncryptedData, ULONG *ulEncryptedDataLen);
typedef ULONG (DEVAPI *PFN_SKF_DecryptInit)(HANDLE hKey, BLOCKCIPHERPARAM DecryptParam);
typedef ULONG (DEVAPI *PFN_SKF_Decrypt)(HANDLE hKey, BYTE * pbEncryptedData, ULONG ulEncryptedLen, BYTE * pbData, ULONG * pulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_DecryptUpdate)(HANDLE hKey, BYTE * pbEncryptedData, ULONG ulEncryptedLen, BYTE * pbData, ULONG * pulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_DecryptFinal)(HANDLE hKey, BYTE *pbDecryptedData, ULONG *pulDecryptedDataLen);
typedef ULONG (DEVAPI *PFN_SKF_DigestInit)(DEVHANDLE hDev, ULONG ulAlgID, ECCPUBLICKEYBLOB *pPubKey, unsigned char *pucID, ULONG ulIDLen, HANDLE *phHash);
typedef ULONG (DEVAPI *PFN_SKF_Digest)(HANDLE hHash, BYTE *pbData, ULONG ulDataLen, BYTE *pbHashData, ULONG *pulHashLen);
typedef ULONG (DEVAPI *PFN_SKF_DigestUpdate)(HANDLE hHash, BYTE *pbData, ULONG ulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_DigestFinal)(HANDLE hHash, BYTE *pHashData, ULONG *pulHashLen);
typedef ULONG (DEVAPI *PFN_SKF_MacInit)(HANDLE hKey, BLOCKCIPHERPARAM* pMacParam, HANDLE *phMac);
typedef ULONG (DEVAPI *PFN_SKF_Mac)(HANDLE hMac, BYTE* pbData, ULONG ulDataLen, BYTE *pbMacData, ULONG *pulMacLen);
typedef ULONG (DEVAPI *PFN_SKF_MacUpdate)(HANDLE hMac, BYTE * pbData, ULONG ulDataLen);
typedef ULONG (DEVAPI *PFN_SKF_MacFinal)(HANDLE hMac, BYTE *pbMacData, ULONG *pulMacDataLen);
typedef ULONG (DEVAPI *PFN_SKF_CloseHandle)(HANDLE hHandle);
typedef ULONG (DEVAPI *PFN_SKF_CreateContainer)(HAPPLICATION hApplication, LPSTR szContainerName, HCONTAINER *phContainer);
typedef ULONG (DEVAPI *PFN_SKF_DeleteContainer)(HAPPLICATION hApplication, LPSTR szContainerName);
typedef ULONG (DEVAPI *PFN_SKF_OpenContainer)(HAPPLICATION hApplication, LPSTR szContainerName, HCONTAINER *phContainer);
typedef ULONG (DEVAPI *PFN_SKF_CloseContainer)(HCONTAINER hContainer);
typedef ULONG (DEVAPI *PFN_SKF_EnumContainer)(HAPPLICATION hApplication, LPSTR szContainerName, ULONG *pulSize);
typedef ULONG (DEVAPI *PFN_SKF_GetContainerType)(HCONTAINER hContainer, ULONG *pulContainerType);
typedef ULONG (DEVAPI *PFN_SKF_ImportCertificate)(HCONTAINER hContainer, BOOL bSignFlag, BYTE* pbCert, ULONG ulCertLen);
typedef ULONG (DEVAPI *PFN_SKF_ExportCertificate)(HCONTAINER hContainer, BOOL bSignFlag, BYTE* pbCert, ULONG *pulCertLen);
typedef ULONG (DEVAPI *PFN_SKF_EnumDev)(BOOL bPresent, LPSTR szNameList, ULONG *pulSize);
typedef ULONG (DEVAPI *PFN_SKF_DisConnectDev)(DEVHANDLE hDev);
typedef ULONG (DEVAPI *PFN_SKF_ConnectDev)(LPSTR szName, DEVHANDLE *phDev);
typedef ULONG (DEVAPI *PFN_SKF_ECCSignData)(HCONTAINER hContainer, BYTE *pbData, ULONG  ulDataLen, PECCSIGNATUREBLOB pSignature);
typedef ULONG (DEVAPI *PFN_SKF_WaitForDevEvent)(LPSTR szDevName,ULONG *pulDevNameLen, ULONG *pulEvent);
typedef ULONG (DEVAPI *PFN_SKF_CancelWaitForDevEvent)();

typedef struct SKF_API {
    PFN_SKF_VerifyPIN pfSKF_VerifyPIN;
    PFN_SKF_GetPINInfo pfSKF_GetPINInfo;
    PFN_SKF_UnblockPIN pfSKF_UnblockPIN;
    PFN_SKF_ClearSecureState pfSKF_ClearSecureState;
    PFN_SKF_CreateApplication pfSKF_CreateApplication;
    PFN_SKF_EnumApplication pfSKF_EnumApplication;
    PFN_SKF_DeleteApplication pfSKF_DeleteApplication;
    PFN_SKF_OpenApplication pfSKF_OpenApplication;
    PFN_SKF_CloseApplication pfSKF_CloseApplication;
    PFN_SKF_CreateFile pfSKF_CreateFile;
    PFN_SKF_DeleteFile pfSKF_DeleteFile;
    PFN_SKF_EnumFiles pfSKF_EnumFiles;
    PFN_SKF_GetFileInfo pfSKF_GetFileInfo;
    PFN_SKF_ReadFile pfSKF_ReadFile;
    PFN_SKF_WriteFile pfSKF_WriteFile;
    PFN_SKF_GenRandom pfSKF_GenRandom;
    PFN_SKF_GenExtRSAKey pfSKF_GenExtRSAKey;
    PFN_SKF_GenRSAKeyPair pfSKF_GenRSAKeyPair;
    PFN_SKF_ImportRSAKeyPair pfSKF_ImportRSAKeyPair;
    PFN_SKF_RSASignData pfSKF_RSASignData;
    PFN_SKF_RSAVerify pfSKF_RSAVerify;
    PFN_SKF_RSAExportSessionKey pfSKF_RSAExportSessionKey;
    PFN_SKF_ExtRSAPubKeyOperation pfSKF_ExtRSAPubKeyOperation;
    PFN_SKF_ExtRSAPriKeyOperation pfSKF_ExtRSAPriKeyOperation;
    PFN_SKF_GenECCKeyPair pfSKF_GenECCKeyPair;
    PFN_SKF_ImportECCKeyPair pfSKF_ImportECCKeyPair;
    PFN_SKF_ECCSignData pfSKF_ECCSignData;
    PFN_SKF_ECCVerify pfSKF_ECCVerify;
    PFN_SKF_ECCExportSessionKey pfSKF_ECCExportSessionKey;
    PFN_SKF_ExtECCEncrypt pfSKF_ExtECCEncrypt;
    PFN_SKF_ExtECCDecrypt pfSKF_ExtECCDecrypt;
    PFN_SKF_ExtECCSign pfSKF_ExtECCSign;
    PFN_SKF_ExtECCVerify pfSKF_ExtECCVerify;
    PFN_SKF_ExportPublicKey pfSKF_ExportPublicKey;
    PFN_SKF_ImportSessionKey pfSKF_ImportSessionKey;
    PFN_SKF_SetSymmKey pfSKF_SetSymmKey;
    PFN_SKF_EncryptInit pfSKF_EncryptInit;
    PFN_SKF_Encrypt pfSKF_Encrypt;
    PFN_SKF_EncryptUpdate pfSKF_EncryptUpdate;
    PFN_SKF_EncryptFinal pfSKF_EncryptFinal;
    PFN_SKF_DecryptInit pfSKF_DecryptInit;
    PFN_SKF_Decrypt pfSKF_Decrypt;
    PFN_SKF_DecryptUpdate pfSKF_DecryptUpdate;
    PFN_SKF_DecryptFinal pfSKF_DecryptFinal;
    PFN_SKF_DigestInit pfSKF_DigestInit;
    PFN_SKF_Digest pfSKF_Digest;
    PFN_SKF_DigestUpdate pfSKF_DigestUpdate;
    PFN_SKF_DigestFinal pfSKF_DigestFinal;
    PFN_SKF_MacInit pfSKF_MacInit;
    PFN_SKF_Mac pfSKF_Mac;
    PFN_SKF_MacUpdate pfSKF_MacUpdate;
    PFN_SKF_MacFinal pfSKF_MacFinal;
    PFN_SKF_CloseHandle pfSKF_CloseHandle;
    PFN_SKF_CreateContainer pfSKF_CreateContainer;
    PFN_SKF_DeleteContainer pfSKF_DeleteContainer;
    PFN_SKF_OpenContainer pfSKF_OpenContainer;
    PFN_SKF_CloseContainer pfSKF_CloseContainer;
    PFN_SKF_EnumContainer pfSKF_EnumContainer;
    PFN_SKF_GetContainerType pfSKF_GetContainerType;
    PFN_SKF_ImportCertificate pfSKF_ImportCertificate;
    PFN_SKF_ExportCertificate pfSKF_ExportCertificate;
    PFN_SKF_EnumDev pfSKF_EnumDev;
    PFN_SKF_ConnectDev pfSKF_ConnectDev;
    PFN_SKF_DisConnectDev pfSKF_DisConnectDev;
    PFN_SKF_CancelWaitForDevEvent pfSKF_CancelWaitForDevEvent;
    PFN_SKF_WaitForDevEvent pfSKF_WaitForDevEvent;
