...
#define SM2_SERVER_CERT     "../c/server/sm2.sig.crt.pem"
#define SM2_SERVER_KEY      "../c/server/sm2.sig.key.pem"

#define SM2_SERVER_ENC_CERT     "../c/server/sm2.enc.crt.pem"
#define SM2_SERVER_ENC_KEY      "../c/server/sm2.enc.key.pem"

#define SM2_SERVER_CA_CERT  "../c/server/rca.crt"
